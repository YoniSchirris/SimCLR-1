## Edited file from the original staintools repo. 
## It checks if the linalg works out, which doesn't work out if the mask leaves us with only 0 or 1 pixel.
## We then return false, which will lead the stain_normalizer to return an unnormalized image.
